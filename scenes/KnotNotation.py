...
class KnotNotation(KnotScene):
    def construct(self):
        basic_knot = Knot("3_1")
        # basic_knot.textMobject.set_color_by_tex_color_map()
        ...
        self.play(ApplyMethod(basic_knot.shift, LEFT * 6), ApplyMethod(basic_knot.textMobject.shift, LEFT * 6))
        ...
        self.play(FadeOut(basic_knot), FadeOut(sub_l1), FadeOut(sub_l2), FadeOut(sub_l3))